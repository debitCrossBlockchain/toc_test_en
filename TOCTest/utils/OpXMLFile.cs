...
{
    public class OpXMLFile
    {
        // 实现对Opml频道file的操作
        public static bool OprationOpmlFile(string file, string[] xpathstr, string OprationMode, string Title, string Url)
        {
            try
            {
        ...
        //创建顶层目录
        public static bool CreateRootSon(string file, string Title)
        {
            try
            {
